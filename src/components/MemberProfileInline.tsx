...
import { Calendar, MessageCircle, FileText, ExternalLink, Github, Linkedin, Building2 } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Avatar, AvatarImage, AvatarFallback } from '@/components/ui/avatar';

interface MemberProfileInlineProps {
  memberName: string;
  teamId: string;
}
...
const MemberProfileInline = ({ memberName, teamId }: MemberProfileInlineProps) => {
  ...
  if (!member) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">요청하신 팀원의 정보를 찾을 수 없습니다.</p>
      </div>
    );
  }
...
export default MemberProfileInline;
